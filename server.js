...
const db = require('./models'); // Importa a instância do Sequelize e modelos (src/models/index.js)
const scheduler = require('./jobs/scheduler'); // Importa o nosso agendador de tarefas (src/jobs/scheduler.js)
